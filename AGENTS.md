...
- **No User Account Number Generation:** Do not generate or assign `accountNumber` (e.g. 2050xxxxxxxx) for users during user creation, registration, or approval. Account numbers are not needed.
