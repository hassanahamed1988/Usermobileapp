...
const renderView = (view: StoreState['currentView'], language: string) => {
  ...
  const shouldBeFullWidth = currentView === 'MY_INCOME' || currentView === 'CHAT' || currentView === 'SETTINGS' || currentView === 'WALLET' || currentView === 'SEARCH' || currentView === 'PAYMENT' || currentView === 'PURCHASE' || currentView === 'NEW_PURCHASE';
